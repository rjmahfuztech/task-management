...
from users.views import sign_up,activate_user,CustomLoginView, ProfileView, CustomPasswordChangeView, CustomPasswordResetView, CustomPasswordResetConfirmView, EditProfileView,AdminDashboardView,GroupListView,CreateGroupView,AssignRoleView
