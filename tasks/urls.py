...
from tasks.views import manager_dashboard,employee_dashboard,create_task,view_task,task_details,update_task,delete_task,dashboard, CreateTask,ViewProject, TaskDetails, UpdateTask
